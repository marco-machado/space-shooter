...
- **Rationale**: Prevents automated changes to complex game scenes and game systems
...
- `src/systems/*.js` - game systems protected from automated changes
...
- **NEVER TEST**: Game scenes, game systems, or Phaser-dependent code
...
eslint src/systems/  # FORBIDDEN: Protected game systems
```
...
2. **game System Complexity**: Game systems have intricate dependencies that linting can disrupt
