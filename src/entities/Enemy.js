...
class Enemy extends Entity {
  ...
  initializeComponents(config) {
    ...
    // Collision component
    const collisionConfig = CollisionComponent.createEnemyConfig(this.enemyType);
    collisionConfig.damageAmount = config.collisionDamage;
   ...
   * @param {Entity} leader - Formation leader
